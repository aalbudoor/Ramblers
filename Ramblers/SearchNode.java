...
public  class SearchNode {
  ...
  //change from search2
  private int globalCost; // parentGlobalCost + localCost
  private int localCost;  // GenertionCost from the parent (local generation cost)
  private int estRemCost; //A*
  private int estTotalCost; //A* // estRemCost + globalCost
